package kr.scripton.biz.jwt.util

import kr.scripton.biz.jwt.dto.AuthorizedUserClaims
...
//		return request.getAttribute(AuthorizedUserClaims.USER_USERNAME) as String
//	}
//
//	fun getUserNickname(request: HttpServletRequest): String {
//		return request.getAttribute(AuthorizedUserClaims.USER_NICKNAME) as String
//	}
//
//	fun getUserRole(request: HttpServletRequest): Collection<String> {
//		return request.getAttribute(AuthorizedUserClaims.USER_ROLE) as Collection<String>
//	}
}